...
import "../extension/Staking721TokenId.sol";
...
contract Staking721TokenIds is ContractMetadata, Multicall, Ownable, Staking721TokenId, ERC165, IERC721Receiver {
    ...
    constructor(
        ...
        uint256[] memory _stakingTokenAllowedId
    ) Staking721TokenId(_stakingToken, _stakingTokenAllowedId) {
